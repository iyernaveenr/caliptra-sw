...
impl Bus for NullBus {
    fn read(&mut self, _size: RvSize, _addr: RvAddr, _access_type: caliptra_emu_bus::BusAccessType) -> Result<RvData, caliptra_emu_bus::BusError> {
...
impl<TBus: Bus> Bus for BusLogger<TBus> {
    fn read(&mut self, size: RvSize, addr: RvAddr, _access_type: caliptra_emu_bus::BusAccessType) -> Result<RvData, caliptra_emu_bus::BusError> {
